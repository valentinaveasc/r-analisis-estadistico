...
En base al analisis realizado, no se demostraron diferencias estadísticamente significativas entre los distintos grupos de la variable sobre religión respecto a los niveles de confianza institucional. El modelo de regresión solo logra explicar el 1% de la vairiabilidad sobre la confianza institucional, por tanto en base a lo estimado la religión no tiene demasiada incidencia sobre cómo se comporten los niveles de confianza institucional. A partir de esto se reconoce como un problema que puede haber influenciado en este análisis refiere la disparidad en cuanto a cantidad de casos entre las categorías de la variable de religión
